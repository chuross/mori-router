...
object PackageNames {
    ...
    const val HASH_MAP = "java.util.HashMap"
    const val ARRAY_LIST = "java.util.ArrayList"
    const val CALLABLE = "java.util.concurrent.Callable"
    ...
    const val VIEW_COMPAT: String = "androidx.core.view.ViewCompat"
    const val SUPPORT_FRAGMENT: String = "androidx.fragment.app.Fragment"
    const val SUPPORT_FRAGMENT_MANAGER: String = "androidx.fragment.app.FragmentManager"
    const val SUPPORT_FRAGMENT_TRANSACTION: String = "androidx.fragment.app.FragmentTransaction"
    const val SHARED_ELEMENT_CALLBACK: String = "androidx.core.app.SharedElementCallback"
}